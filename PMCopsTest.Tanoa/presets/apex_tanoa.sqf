...
KP_liberation_little_bird_classname = "LOP_PMC_MH9"; 				// These are the little birds which spawn on the Freedom or at Chimera base.															Default is "B_Heli_Light_01_F".
...
infantry_units = [
	["rhsgref_hidf_rifleman",20,0,0],											//Rifleman
	["rhsgref_hidf_rifleman_m72",30,0,0],										//Rifleman (AT)
	["rhsgref_hidf_grenadier",25,0,0],										//Grenadier
	["rhsgref_hidf_autorifleman",25,0,0],										//Autorifleman
	["rhsgref_hidf_marksman",30,0,0],											//Marksman
	["B_T_Soldier_AT_F",50,10,0],										//AT Specialist
	["B_T_Soldier_AA_F",50,10,0],										//AA Specialist
	["rhsgref_hidf_medic",30,0,0],												//Combat Life Saver
	...
	["rhsgref_hidf_sniper",70,5,0],											//Sniper
...
light_vehicles = [
	...
	["rhsusf_mrzr4_d",60,0,30],											//mrzr4
	["B_T_LSV_01_unarmed_F",75,0,50],									//Prowler
	["B_T_LSV_01_armed_F",75,40,50],									//Prowler (HMG)
	["B_T_MRAP_01_F",100,0,50],											//Hunter
	["B_T_MRAP_01_hmg_F",100,70,50],									//Hunter (HMG)
	["rhsgref_hidf_m1025",75,0,50],										//M1025A2
	["rhsgref_hidf_m1025_m2",100,40,50],									//M1025A2 (M2)
	["rhsgref_hidf_M998_4dr_fulltop",75,0,50],								//M998 fulltop
...
heavy_vehicles = [
	["rhsgref_hidf_m113a3_m2",200,40,100],									//M113A3 gref (M2)
	["rhsgref_hidf_m113a3_unarmed",200,0,100],									//M113A3 gref (M2)
	...
	["B_T_MBT_01_cannon_F",500,300,200],								//M2A1 Slammer
...
air_vehicles = [
	["B_UAV_01_F",80,0,25],												//AR-2 Darter
	["LOP_PMC_MH9",200,0,100],									//MH-9 Hummingbird
	["LOP_PMC_MH9_armed",200,100,100],					//AH-9 Pawnee
...
militia_vehicles = [
	...
	"LOP_BH_Landrover_M2"											//Offroad (HMG)
];

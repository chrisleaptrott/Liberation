...
F_isKeystone = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_isKeystone.sqf";
F_isShadow = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_isShadow.sqf";
